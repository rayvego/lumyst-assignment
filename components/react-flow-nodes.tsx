import { ReactFlowNode } from "@/core/types";
...
export function C1CategoryNode({ data, selected }: CategoryNodeProps) {
  return (
    <div
      className={`bg-gradient-to-br from-purple-600 to-purple-800 border-2 border-purple-400 rounded-lg p-3 shadow-lg hover:shadow-xl hover:from-purple-500 hover:to-purple-700 transition-all cursor-pointer min-w-[220px] max-w-[280px] w-[240px] overflow-hidden ${
...
export function C2SubcategoryNode({ data, selected }: CategoryNodeProps) {
  return (
    <div
      className={`bg-gradient-to-br from-indigo-600 to-indigo-800 border-2 border-indigo-400 rounded-lg p-3 shadow-lg hover:shadow-xl hover:from-indigo-500 hover:to-indigo-700 transition-all cursor-pointer min-w-[200px] max-w-[260px] w-[220px] overflow-hidden ${
        selected ? "ring-4 ring-indigo-300 scale-105" : ""
      }`}
    >
      {/* Multiple handles for better edge routing */}
      <Handle
        ...
        position={Position.Top}
        id="top-target"
        className="w-3 h-3 bg-indigo-300 !border-2 !border-indigo-600"
      />
      <Handle
        type="target"
        position={Position.Left}
...
export function GraphNode({ data, selected }: BaseNodeProps) {
  ...
  const colors = getNodeColors(data.type as string);

  return (
    <div
      className={`border-2 rounded-lg p-3 shadow-lg hover:shadow-xl transition-all cursor-pointer min-w-[200px] max-w-[260px] w-[220px] overflow-hidden ${
